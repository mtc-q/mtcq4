...
| `style.css` | The black & white design system |
...
- Web app config keys — already pasted into `app.js` ✔
...
- The `apiKey` in `app.js` is **not a secret** — Firebase web keys are meant to be
